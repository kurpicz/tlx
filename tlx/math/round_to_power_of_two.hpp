...
static constexpr inline Integral round_up_to_power_of_two_template(Integral n) {
    --n;
...
static constexpr inline int round_up_to_power_of_two(int i) {
    return round_up_to_power_of_two_template(i);
}

//! does what it says: round up to next power of two
static constexpr inline unsigned int round_up_to_power_of_two(unsigned int i) {
    return round_up_to_power_of_two_template(i);
}

//! does what it says: round up to next power of two
static constexpr inline long round_up_to_power_of_two(long i) {
    return round_up_to_power_of_two_template(i);
}
...
//! does what it says: round up to next power of two
static constexpr inline long long round_up_to_power_of_two(long long i) {
    return round_up_to_power_of_two_template(i);
}
...
static constexpr inline int round_down_to_power_of_two(int i) {
...
//! does what it says: round down to next power of two
static constexpr inline long round_down_to_power_of_two(long i) {
    return round_up_to_power_of_two(i + 1) >> 1;
}
...
//! does what it says: round down to next power of two
static constexpr inline long long round_down_to_power_of_two(long long i) {
    return round_up_to_power_of_two(i + 1) >> 1;
}
